    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="border border-stone-200 grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-full">
          ...
          <div className="p-4 sm:p-6 lg:p-8 lg:border-r border-stone-200">
            <div className="mb-6">
            ...
            <form className="space-y-4 sm:space-y-6">
              <div>
                <label className="text-xs uppercase tracking-wider font-semibold text-neutral-700 mb-2 block">
                  Story Title
                </label>
                <input
                  name="title"
          ...
          <div className="p-4 sm:p-6 lg:p-8 flex flex-col min-h-96 lg:min-h-auto">
            <div className="mb-4">
              <div className="text-xs uppercase tracking-wider font-semibold text-neutral-700 mb-1">
                RECORDER
              </div>
            ...
            <div className="flex-1 flex flex-col">
              <div className="flex-1 bg-neutral-50 border border-stone-200 rounded-sm flex items-center justify-center mb-4 sm:mb-6">
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl text-neutral-300 mb-2 sm:mb-3">
                    🎤
                  </div>
              ...
              <div className="text-xs text-neutral-500 mt-3 sm:mt-4">
